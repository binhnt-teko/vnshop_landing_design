...
// const nowURL = 'http://antd-landing.now.sh/';
// const nowURL = 'http://localhost:7112/';
const nowURL = 'http://localhost/';
const landingURL = 'localhost/bidv-landing'
...
class PublishModal extends React.Component {
  ...
  onMonitorPublishState = (id) => {
    ...
    const currentUrl = `${landingURL}/${templateData.uid}`;
              ...
              notification.open({
                ...
                description: (
                  <p>
                    ...
                    <a href={`http://${currentUrl}`} target="_blank">
                      {currentUrl}
                    </a>
                  </p>
                ),
...
<html>
  ...
  render() {
    ...
    console.log("binhnt.PublishModel; render props = ", props)
    ...
    const url = `localhost:3000/bidv-landing/${templateData.uid}`;
    return (
      <Modal
        {...props}
      >
