...
import { deepCopy } from '../../../share/utils';
import { getIdsAndCurrentData } from '../../../utils/utils';
...
class MenuEditView extends React.PureComponent {
  ...
  render() {
    ...
    // console.log("Binhnt.MenuEditView: render: ", currentEditData, templateData);
    ...
    if (!currentEditTemplateData.children) {
      // console.log("Binhnt.MenuEditView: render: no children");
